...
var ASM_CONSTS = {
  84720: () => { if (document.fullscreenElement) return 1; },  
 84766: () => { return document.getElementById('canvas').width; },  
 84818: () => { return parseInt(document.getElementById('canvas').style.width); },  
 84886: () => { document.exitFullscreen(); },  
 84913: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 84986: () => { if (document.fullscreenElement) return 1; },  
 85032: () => { return document.getElementById('canvas').width; },  
 85084: () => { return screen.width; },  
 85109: () => { document.exitFullscreen(); },  
 85136: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 85269: () => { if (document.fullscreenElement) return 1; },  
 85315: () => { return document.getElementById('canvas').width; },  
 85367: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85435: () => { if (document.fullscreenElement) return 1; },  
 85481: () => { return document.getElementById('canvas').width; },  
 85533: () => { return screen.width; },  
 85558: () => { if (document.fullscreenElement) return 1; },  
 85604: () => { return document.getElementById('canvas').width; },  
 85656: () => { return screen.width; },  
 85681: () => { document.exitFullscreen(); },  
 85708: () => { if (document.fullscreenElement) return 1; },  
 85754: () => { return document.getElementById('canvas').width; },  
 85806: () => { return parseInt(document.getElementById('canvas').style.width); },  
 85874: () => { document.exitFullscreen(); },  
 85901: () => { return screen.width; },  
 85926: () => { return screen.height; },  
 85952: () => { return window.screenX; },  
 85979: () => { return window.screenY; },  
 86006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 86059: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 86130: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 86187: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 86258: () => { if (document.fullscreenElement) return 1; },  
 86304: () => { if (document.pointerLockElement) return 1; }
};
